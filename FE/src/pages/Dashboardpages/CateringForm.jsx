...
export default function CateringForm({ initial, onClose, onSuccess }) {
...
<form className="catering-form" onSubmit={handleSubmit}>
      ...
      <div className="flex items-center justify-end gap-3 mt-6">
        ...
        <button
          type="submit"
          disabled={saving}
          className="px-4 py-2 rounded-md bg-[#FFF200] text-black font-semibold hover:brightness-95 disabled:opacity-60"
        >
