  ...
  const dishes = [
    {
      ...
      image: "https://images.pexels.com/photos/4161714/pexels-photo-4161714.jpeg?auto=compress&cs=tinysrgb&w=480"
    },
    {
      id: 2,
      name: "Pasta",
      price: "$80",
      description: "Silky white sauce with parmesan and herbs.",
      image: "https://images.pexels.com/photos/5894767/pexels-photo-5894767.jpeg?auto=compress&cs=tinysrgb&w=480"
    },
    {
      id: 3,
      name: "Pasta",
      price: "$80",
      description: "Silky white sauce with parmesan and herbs.",
      image: "https://images.pexels.com/photos/6241091/pexels-photo-6241091.jpeg?auto=compress&cs=tinysrgb&w=480"
    },
    {
      id: 4,
      name: "Pasta",
      price: "$80",
      description: "Silky white sauce with parmesan and herbs.",
      image: "https://images.pexels.com/photos/11101711/pexels-photo-11101711.png?auto=compress&cs=tinysrgb&w=480"
    },
    {
      id: 5,
      name: "Pasta",
      price: "$80",
      description: "Silky white sauce with parmesan and herbs.",
      image: "https://images.pexels.com/photos/26597663/pexels-photo-26597663.jpeg?auto=compress&cs=tinysrgb&w=480"
    },
    {
      id: 6,
      name: "Pasta",
      price: "$80",
      description: "Silky white sauce with parmesan and herbs.",
      image: "https://images.pexels.com/photos/29039084/pexels-photo-29039084.jpeg?auto=compress&cs=tinysrgb&w=480"
    }
  ]
              ...
              {dishes.map((dish) => (
                <div key={dish.id} className="hot-dish-card">
                  ...
                  <div className="hot-dish-content">
                    ...
                    <button className="hot-dish-cart-btn" aria-label="Add to cart">
